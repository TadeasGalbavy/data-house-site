    ...
    const translations = {
      ...
      en: {
        ...
        'services-h2': 'What we <em>can do for you</em>',
        ...
        'how-h2': 'Simple process.<br><em>No surprises.</em>',
        ...
        'outcome-label': 'Partnership',
        'outcome-h2': 'Long-term partnerships <em>instead of one-off projects.</em>',
        ...
        'outcome-p2': 'That is why we prefer long-term partnerships. We often start with an audit or a specific challenge and continue with reporting, automation and ongoing data improvements based on the company’s needs.',
        'outcome-p3': 'The goal is not to deliver another tool into the business, but to gradually build a way of working with data that supports better decisions.',
        'solutions-label': 'Real-World Examples',
        'solutions-h2': 'Every challenge is different. <em>The approach stays the same.</em>',
        'solutions-intro': 'Examples of situations where the combination of data, automation and process understanding delivered measurable results and helped the business operate more efficiently.',
        ...
        'solution1-problem': 'Too much money was tied up in inventory and purchasing decisions were often based on experience rather than data.',
        'solution1-solution': 'Analysis of sales, turnover and inventory levels helped create a clearer view of what should be kept in stock and what should be ordered more carefully.',
        'solution1-result': 'Inventory value reduced by approximately €50,000 while keeping product availability above 80%.',
        'solution1-link': 'View solution',
        'solution2-title': 'Purchasing Automation',
        'solution2-problem': 'Product purchasing was time-consuming and heavily dependent on manual Excel work.',
        'solution2-solution': 'A tool was built to process input data, evaluate replenishment needs and prepare order recommendations.',
        'solution2-result': 'Less manual work, fewer errors and faster preparation of purchase orders.',
        'solution2-link': 'GitHub / solution preview',
        'solution3-title': 'Label Printing Automation',
        'solution3-problem': 'Warehouse label printing required repeated manual input and checking.',
        'solution3-solution': 'A tool was created to process an Excel file and automatically prepare a batch of labels for printing.',
        'solution3-result': 'Faster printing, fewer manual steps and lower risk of errors.',
        'solution3-link': 'GitHub / solution preview',
        'solution4-title': 'Personalised Analytics Dashboard',
        'solution4-problem': 'The client needed business performance visibility but had no budget for a commercial BI tool.',
        'solution4-solution': 'A personalised dashboard with key metrics, charts and the option to export clean data.',
        'solution4-result': 'Quick access to key indicators as a foundation for reporting — without dependency on expensive tools.',
        'solution4-link': 'Solution detail',
